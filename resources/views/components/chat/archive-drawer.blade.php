    ...
    <div class="space-y-4">
        <div class="chat-top-archive justify-between">
            ...
            <div class="flex items-center gap-2">
                <span class="text-[11px] uppercase tracking-[0.28em] text-muted">Mode</span>
                <select id="archiveModeSelect"
                    class="rounded-md px-2 py-1 text-xs uppercase tracking-[0.18em] outline-none focus:ring-1 focus:ring-[var(--accent)]"
        ...
        <details class="chat-control-panel" open>
            ...
            <div class="mt-3 flex flex-col gap-4">
                <section class="rounded-xl border px-4 py-4 flex flex-col gap-4"
                    style="border-color: var(--border-muted); background: rgba(8, 14, 24, 0.65);">
                    <div class="flex items-center justify-between gap-3">
                        ...
                        <span class="rounded-full border px-3 py-1 text-[11px] font-semibold uppercase tracking-[0.18em]"
                            style="border-color: rgba(92,122,234,0.25); background: rgba(92,122,234,0.14); color: rgba(227,234,255,0.85);">
                            Pre-search
                        </span>
                    </div>
                    ...
                    <p class="text-xs leading-5 text-muted">Use any combination of filters to cut down the corpus before the hybrid search runs. - استخدم أي مجموعة من عوامل التصفية لتقليل النتائج قبل البحث الهجين.</p>

                    <div class="mt-4 grid gap-3" style="grid-template-columns: repeat(auto-fit, minmax(160px, 1fr));">
