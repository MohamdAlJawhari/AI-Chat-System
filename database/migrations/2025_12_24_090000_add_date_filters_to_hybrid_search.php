...
return new class extends Migration {
    public function up(): void
    {
        ...
        DB::unprepared("DROP FUNCTION IF EXISTS hybrid_search_docs(TEXT, vector, INT, INT, REAL, REAL, TEXT, TEXT, TEXT, BOOLEAN, TIMESTAMPTZ, TIMESTAMPTZ);");
        DB::unprepared("DROP FUNCTION IF EXISTS hybrid_search(TEXT, vector, INT, REAL, TEXT, TEXT, TEXT, BOOLEAN, TIMESTAMPTZ, TIMESTAMPTZ);");
        ...
        CREATE OR REPLACE FUNCTION hybrid_search(
          ...
          is_breaking_filter BOOLEAN DEFAULT NULL,
        ...
        sem AS (
          ...
          WHERE c.embedding IS NOT NULL
            ...
            AND (date_from_filter IS NULL OR n.date_sent >= date_from_filter)
            AND (date_to_filter IS NULL OR n.date_sent <= date_to_filter)
